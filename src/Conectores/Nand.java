 ...
 */
public class Nand extends Conector implements interfazConector {
    /*
     * Variable para obtener el nombre del conector
     */
    public static String nombre ="Nand";

    /**
     * Constructor clase Nand
     * @param image - Imagen del conector
     * @param entrada1 - Primera entrada del conector
     * @param entrada2 - Segunda entrada del conector
     */
    public Nand(Image image, Conector entrada1, Conector entrada2) {
